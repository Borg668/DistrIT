...
public class ServerRecord {
     ...
     * @param specificClientName Name of client specifically allocated to this server.  A ""
     * or null value define a server with no specific client
     */
    public ServerRecord( String name, InteractiveTaskServer server, String specificClientName ) {
        this.name = name;
        this.server = server;
     ...
     * @param specificClientName The name of the client specifically allocated to this server
     */

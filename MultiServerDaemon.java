...
public class MultiServerDaemon implements InteractiveTaskServer {
    ...
    /** Creates a new instance of MultiServerStage2
      * @param args Element 0 of this arraylist is a String holding the file name of the configuration file.
     * Element 1 is a String holding the file name of the log file.
     */
